    ...
    <div class="container">
      ...
      <div class="row">
          ...
          <div class="report">
            ...
            <p>In designing the app, we focused on one prototypical user, Tammy. Tammy is a working mother who views grocery shopping as a “mom of the house chore”. She wants to get shopping done as quickly and painlessly as possible, and she’s developed habits that make her a pro at grocery shopping. The energy she does devotes to shopping goes into making sure she gets the food that her family satisfies her family's taste and nutritional needs. Tammy would like to save, but she is only going to focus on getting the food that meets her families requirements. In creating this design, we’ve focused primarily on making sure that Tammy can get the best price possible on the food she wants to buy. A crucial part of this app is that it allows Tammy to shop in her own way while finding savings that work with her existing habits.
            </p>
